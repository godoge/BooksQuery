...
public class BookCaseAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (new File(imagePath).exists()) {
            ...
            iv.setLayoutParams(new FrameLayout.LayoutParams(viewWidth / 3, viewWidth / 3));
            ...
            TextView tv = (TextView) convertView.findViewById(R.id.item_book_tv_item_title);
            tv.setText(getItem(position).getTitle());
            tv.setLayoutParams(new FrameLayout.LayoutParams(viewWidth / 3, viewWidth / 3));
