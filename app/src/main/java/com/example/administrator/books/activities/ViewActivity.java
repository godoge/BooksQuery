...
public class ViewActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void displayBookByModel(Book book) {
        ...
        if (!new File(book.getImageLarge()).exists())
            iv_cover.setImageResource(R.drawable.blank_cover);
        else {
    ...
    public void onCreateContextMenu(ContextMenu menu, View v, ContextMenu.ContextMenuInfo menuInfo) {
        ...
        menu.findItem(R.id.book_view_refresh).setVisible(false);
        menu.findItem(R.id.book_view_delete).setVisible(false);
    }
